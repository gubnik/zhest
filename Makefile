...
arglist.o: asm/arglist.asm
	@echo "Not implemented" 
	#nasm -f elf64 -o arglist.o asm/arglist.asm
...
test: syscalls.o format.o printbuf.o list.o test.c
	$(CC) $(CFLAGS) -c test.c -nostdlib -o main.o
	$(CC) $(CFLAGS) main.o list.o printbuf.o syscalls.o -o test

.PHONY: test all list.o format.o syscalls.o
